...
class AppStrings {
  static const Map<String, Map<String, String>> _t = {
    'es': {
      ...
      'error_promociones': 'No fue posible obtener las promociones',
      ...
      'cuenta_eliminada_titulo': 'Cuenta eliminada correctamente',
      'cuenta_eliminada_msg':
          'Tu cuenta y tu sesión fueron eliminadas. Deberás iniciar sesión nuevamente para volver a acceder a la aplicación.',
      'error_eliminar_cuenta':
          'No fue posible eliminar tu cuenta. Inténtalo de nuevo.',
      'error_eliminar_cuenta_sesion':
          'Tu sesión expiró. Inicia sesión nuevamente para continuar.',
      'error_eliminar_cuenta_servidor':
    ...
    'en': {
      ...
      'error_promociones': 'Could not load promotions',
      ...
      'promociones_desc':
          'Discover exclusive discounts on hotels, restaurants, tours and more.',
      ...
      // Delete account
      'eliminando_cuenta': 'Deleting your account...',
      'cuenta_eliminada_titulo': 'Account deleted successfully',
      'cuenta_eliminada_msg':
          'Your account and session have been deleted. You will need to log in again to access the app.',
      'error_eliminar_cuenta':
