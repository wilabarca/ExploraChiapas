...
class UbicacionDestinoModel extends UbicacionDestino {
  const UbicacionDestinoModel({
    required super.id,
  ...
  factory UbicacionDestinoModel.fromJson(Map<String, dynamic> json) {
    return UbicacionDestinoModel(
      id: json['id'].toString(),
