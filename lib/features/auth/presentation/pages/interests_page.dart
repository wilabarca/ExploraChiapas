...
class InterestsPage extends StatefulWidget {
  ...
  @override
  State<InterestsPage> createState() =>
      _InterestsPageState();
}

class _InterestsPageState
    extends State<InterestsPage> {
  ...
  Future<void> _loadData() async {
     ...
     */
    final categories =
        await provider.loadInterestCategories();
  ...
  Future<bool>
      _ensureAuthenticatedAfterRegistration(
  ...
  Future<void> _handleContinuar() async {
    ...
    try {
       ...
       */
      final authenticated =
          await _ensureAuthenticatedAfterRegistration(
        provider,
      );
